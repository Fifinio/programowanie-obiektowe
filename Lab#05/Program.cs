...
class App
{
    public static void Main(string[] args)
    {
        ...
        System.Console.WriteLine("Ćwiczenie 1: ");
        ...
        System.Console.WriteLine("Ćwiczenie 2: ");
        var y = new CurrencyRates();
        System.Console.WriteLine("rates[0]: " + y[0]);
        System.Console.WriteLine("rates[1]: " + y[1]);
        System.Console.WriteLine("rates[2]: " + y[2]);
        System.Console.WriteLine("rates[3]: " + y[3]);
        System.Console.WriteLine("Ćwiczenie 3" );
        var z = new Exercise3();
    }
}
...
class Exercise3: IEnumerable<string>
{
    ...
    {
        return "0x" + this.GetEnumerator().Take(digitCount).ToArray();     
    }
}
